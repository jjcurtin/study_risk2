...
### Model Selection
Our performance metric for model selection and evaluation was area under the Receiver Operating Characteristic curve (auROC).  <!--define and expand on choice? [@vancalsterEvaluationPerformanceMeasures2025]-->.
