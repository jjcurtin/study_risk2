...
shaps_out_grp |>
  write_rds(here::here(path_models, "outer_shapsgrp_6_x_5_1_x_5_day_v12_nested_full.rds"))
```
...
shaps_out_grp_global |>
  write_rds(here::here(path_models, "outer_shapsgrp_global_6_x_5_1_x_5_day_v12_nested_full.rds"))
```
