...
for (k in algorithms) {
  ...
  for (i in feature_sets) {
    ...
    if (k == "xgboost2") {
      ...
      table_hp1 <- results_hp1 |> 
        pull(hp1) |> 
        janitor::tabyl() |>
        rename(hp1 = 1) |> 
        gt::gt()
      
      print(wrap_table(table_hp1,
                 panel = "full",
      ...
      results_hp2 <- results_i |>
        group_by(hp2) |> 
        summarize(roc_auc = median(roc_auc), .groups = "drop")
      
      
      plot_hp2 <- results_hp2 |>  
      ...
      table_hp2 <- results_hp2 |> 
        pull(hp2) |> 
        janitor::tabyl() |> 
        rename(hp2 = 1) |>
        gt::gt()
      
      print(wrap_table(table_hp2,
                 panel = "full",
      ...
      results_hp3 <- results_i |>
        group_by(hp3) |> 
        summarize(roc_auc = median(roc_auc), .groups = "drop")
      
      
      plot_hp3 <- results_hp3 |>  
      ...
      table_hp3 <- results_hp3 |> 
        pull(hp3) |> 
        janitor::tabyl() |> 
        rename(hp3 = 1) |>
        gt::gt()
      
      print(wrap_table(table_hp3,
                 panel = "full",
      ...
      results_hp4 <- results_i |>
        group_by(hp4) |> 
        summarize(roc_auc = median(roc_auc), .groups = "drop")
      
      
      plot_hp4 <- results_hp4 |>  
      ...
      table_hp4 <- results_hp4 |> 
        pull(hp4) |> 
        janitor::tabyl() |> 
        rename(hp4 = 1) |>
        gt::gt()
      
      print(wrap_table(table_hp4,
                 panel = "full",
