...
2. 10 participants were excluded due to unusually low geolocation sensing adherence. 

    - 3 participants had no gps data.

    - 7 participants had fewer than 20 geolocation points per day on average.


3. 14 participants were excluded due to insufficient context data for geolocation points. We required participants have at least two contextualized locations other than their home. 

    - 2 participants had no context data for any locations
