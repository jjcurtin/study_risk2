...
pp_dem |>
  mutate(group = case_match(model,
         ...
         fairness = if_else(model %in% c("not male", 
                                         ...
                                         "small town/rural",
                                         "high school or less"), 
                            "Disadvantaged (not male, Hispanic and/or not White, below poverty, rural, high school or less)",
                            "Advantaged (male, non-Hispanic White, above poverty, urban, some college)"),
