...
pp_dem |>
  mutate(group = case_match(model,
         ...
         fairness = if_else(model %in% c("not male", 
                                         ...
                                         "small town/rural",
                                         "not heterosexual"), 
                            "Disadvantaged (not male, Hispanic and/or not White, below poverty, rural, not heterosexual)",
                            "Advantaged (male, non-Hispanic White, above poverty, urban, heterosexual)"),
