...
pp_dem <- read_csv(here::here(path_models, 
                   ...
                   show_col_types = FALSE)
preds <- read_rds(here::here(path_models, "preds_xgboost_kfold_6_x_5_v7_dyn.rds"))
...
62 possible groups - filtering top 30
```{r}
#| code-fold: true
...
Supplemental figure with all 62 groups
```{r}
#| code-fold: true
