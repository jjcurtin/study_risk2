...
```{r}
#| label: fig-4
#| fig-cap: "Shapley-feature value partial dependence plots. The plots display the relationship between the Shapley value and mean raw feature value (z-scored) for the top 20 important features. The blue lines represent the estimated smooth functions from generalized additive models."
#| message: false
#| fig-width: 10
#| fig-height: 14
#| code-fold: true
